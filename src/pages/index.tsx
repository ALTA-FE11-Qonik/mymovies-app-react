...
const Index = () => {
  ...
  // state sifatnya async, jadi tidak bisa langsung digunakan
  ...
  */
  ...
  function fetchData(page: number) {
    axios
      ...
      .then((data) => {
        // masuk ke then, jika ada respon dari backend, apapun outputnya (berhasil ataupun gagal)
        const { results, total_pages } = data.data; // destructuring
        setDatas(results);
        setTotalPage(total_pages);
      })
      .catch((error) => {
        // masuk ke catch, jika backend tidak merespon samsek, dan biasanya server down
